...
declare class Group {
    ...
    */
    ...
    overlap(target: object, callback: Function);
...
interface Sprite {
    ...
    */
    collide(target: object)
    collide(target: object, callback: Function)
    ...
    */
     ...
     * @type Color
    */
    shapeColor: string | number | p5.Color,

    /**
     * The Sprite's velocity in the X an Y direction.
     * @property Sprite.velocity
     * @type number
    */
    velocity: {
        x?: number;
...
declare function loadSpriteSheet(pathToSpritesheet: string, width: number, height: number, numberOfFrames: number);
declare function loadSpriteSheet(pathToSpritesheet: string, tilesFrames: any);
